...
import com.xetterfb.xetterchat.model.ModelNotification;
     ...
     holder.itemView.setOnLongClickListener(v -> {
         ...
         builder.setPositiveButton("Delete", (dialog, which) -> {
             ...
             ref.child(userId).child("Notifications").child(timestamp).removeValue().addOnSuccessListener(aVoid -> {
                 Toast.makeText(getTimeAgo, "Deleted", Toast.LENGTH_LONG).show();
             }).addOnFailureListener(e -> {
                 Toast.makeText(getTimeAgo, e.getMessage(), Toast.LENGTH_LONG).show();
             });
