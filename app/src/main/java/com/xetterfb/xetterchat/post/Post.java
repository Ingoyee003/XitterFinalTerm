...
post_vine.setVisibility(View.GONE);
        ...
        post_vine.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(mText)) {
                Toast.makeText(this, "Error!!!: Set Caption", Toast.LENGTH_SHORT).show();
            }else {
        ...
        post.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(mText)) {
                Toast.makeText(this, "Error!!!: Enter Caption", Toast.LENGTH_LONG).show();
                return;
            }
            if (image_uri == null){
                pd.setVisibility(View.VISIBLE);
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            dRef.child(timeStamp).setValue(hashMap)
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        type.setText("Text");
                                        Toast.makeText(this, "Successfull, Post Uploaded", Toast.LENGTH_LONG).show();
                                    })
            ...
            hashMap.put("pComments","0");
                ...
                dRef.child(timeStamp).setValue(hashMap)
                        .addOnSuccessListener(aVoid -> {
                            ...
                            Toast.makeText(this, "Successful, Post Uploaded", Toast.LENGTH_LONG).show();
                        })
                        .addOnFailureListener(e -> {
                            pd.setVisibility(View.GONE);
                            Toast.makeText(this, "Successful", Toast.LENGTH_LONG).show();
            ...
            if (uriTask.isSuccessful()){
                ...
                dRef.child(timeStamp).setValue(hashMap)
                        .addOnSuccessListener(aVoid -> {
                            ...
                            Toast.makeText(this, "Successful, Post Uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(e -> {
                            Toast.makeText(Post.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        });
