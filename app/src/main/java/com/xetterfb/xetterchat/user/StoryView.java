...
public class StoryView extends AppCompatActivity {
    ...
    final long storyDuration = 5000L;
    ...
    LottieAnimationView storiesProgressView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reverse.setOnClickListener(v -> reverseStory());
        reverse.setOnTouchListener(onTouchListener);

        skip.setOnClickListener(v -> skipStory());
        skip.setOnTouchListener(onTouchListener);
    }

    private void startStoryProgress() {
        storiesProgressView.playAnimation();
        ...
        storyHandler.postDelayed(storyRunnable, storyDuration);
    }
    ...
    private void resumeStoryProgress() {
        startStoryProgress();
    }
