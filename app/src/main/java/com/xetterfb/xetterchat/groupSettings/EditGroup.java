...
public class EditGroup extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(EditGroup.this, "Error!", Toast.LENGTH_SHORT).show();
                pb.setVisibility(View.GONE);
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    reference.child(GroupId).updateChildren(hashMap)
                            .addOnSuccessListener(aVoid -> {
                                Toast.makeText(INSTANCE, "Profile Photo Updated", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == PERMISSION_CODE) {
            if (grantResults.length > 0 && grantResults[0] ==
                ...
                Toast.makeText(INSTANCE, "Storage permission is required", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.constraintLayoutG) {
            // Check Permission
            ...
            picRef.delete().addOnSuccessListener(aVoid -> {
                ...
                reference.child(GroupId).updateChildren(hashMap)
                        .addOnSuccessListener(aVoid1 -> {
                            Toast.makeText(INSTANCE, "Profile Photo Deleted", Toast.LENGTH_SHORT).show();
                            menu.setVisibility(View.INVISIBLE);
                            pb.setVisibility(View.GONE);
                            bottomSheetDialog.cancel();
                        })
                ...
                Toast.makeText(INSTANCE, "Failed to delete photo", Toast.LENGTH_SHORT).show();
            });
        }
    }
