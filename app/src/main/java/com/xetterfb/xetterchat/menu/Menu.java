...
import com.xetterfb.xetterchat.user.MyFollowing;
import com.xetterfb.xetterchat.welcome.IntroLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "Xetter - Friends Social Network" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.xetterfb.xetterchat";
       ...
       DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(firebaseUser.getUid());
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Menu.this, "Error!!! Please correct it", Toast.LENGTH_LONG).show();
            }
