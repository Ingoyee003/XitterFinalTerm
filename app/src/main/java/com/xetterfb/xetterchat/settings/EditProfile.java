    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
               Toast.makeText(EditProfile.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                pb.setVisibility(View.GONE);
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    reference.child(Objects.requireNonNull(mAuth.getUid())).updateChildren(hashMap)
                            .addOnSuccessListener(aVoid -> {
                                Toast.makeText(EditProfile.this, "Profile Photo Updated", Toast.LENGTH_LONG).show();
            ...
            picRef.delete().addOnSuccessListener(aVoid -> {
                ...
                reference.child(Objects.requireNonNull(mAuth.getUid())).updateChildren(hashMap)
                        .addOnSuccessListener(aVoid1 -> {
                            Toast.makeText(EditProfile.this, "Profile Photo Deleted", Toast.LENGTH_LONG).show();
                            menu.setVisibility(View.INVISIBLE);
                            pb.setVisibility(View.GONE);
                            bottomSheetDialog.cancel();
                        })
