...
import com.xetterfb.xetterchat.menu.Policy;
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getChildrenCount()>0){
                        ...
                        if (TextUtils.isEmpty(name)|| TextUtils.isEmpty(email) || TextUtils.isEmpty(password)){
                            Toast.makeText(SignUp.this, "Enter email & name & password", Toast.LENGTH_SHORT).show();
                            progressBar2.setVisibility(View.INVISIBLE);

                        } else if (password.length()<6){
                            Toast.makeText(SignUp.this, "Password should have minimum 6 characters", Toast.LENGTH_SHORT).show();
                            progressBar2.setVisibility(View.INVISIBLE);
                        }else {
