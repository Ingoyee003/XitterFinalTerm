...
public class UsernameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressBar8.setVisibility(View.GONE);
                Toast.makeText(UsernameActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
        ...
        button.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(username)) {
               Toast.makeText(UsernameActivity.this, "Username is required", Toast.LENGTH_LONG).show();
                progressBar8.setVisibility(View.GONE);
                ...
                usernameQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getChildrenCount() > 0) {
                           ...
                           Toast.makeText(UsernameActivity.this, "Username is taken", Toast.LENGTH_LONG).show();
                            progressBar8.setVisibility(View.GONE);
    ...
    private void addUsername(String username) {
        ...
        Toast.makeText(UsernameActivity.this, "Username updated", Toast.LENGTH_LONG).show();
        progressBar8.setVisibility(View.GONE);
    }
}