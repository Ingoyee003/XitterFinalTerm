...
public class NameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressBar8.setVisibility(View.GONE);
                Toast.makeText(NameActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
        ...
        menu.setOnClickListener(view -> {
            ...
            if(TextUtils.isEmpty(name)) {
               Toast.makeText(NameActivity.this, "Name is required", Toast.LENGTH_LONG).show();
                progressBar8.setVisibility(View.GONE);
            } else {
    ...
    private void addUsername(String name) {
        ...
        Toast.makeText(NameActivity.this, "Name updated", Toast.LENGTH_LONG).show();
