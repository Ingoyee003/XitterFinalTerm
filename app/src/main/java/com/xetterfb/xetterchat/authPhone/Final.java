            ...
            emailQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getChildrenCount()>0){
                        ...
                        Toast.makeText(Final.this, "Username already exist", Toast.LENGTH_LONG).show();
                        progressBar5.setVisibility(View.INVISIBLE);

                    }else {
                        if (TextUtils.isEmpty(email)|| TextUtils.isEmpty(password)){
                            Toast.makeText(Final.this, "Enter name & username", Toast.LENGTH_LONG).show();
                            progressBar5.setVisibility(View.INVISIBLE);
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(Final.this, "Error!", Toast.LENGTH_LONG).show();
                    progressBar5.setVisibility(View.INVISIBLE);
                }
            });
        });
