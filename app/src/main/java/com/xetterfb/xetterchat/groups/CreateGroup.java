...
public class CreateGroup extends AppCompatActivity {
            ...
            usernameQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getChildrenCount()>0){
                        Toast.makeText(CreateGroup.this, "Username already exist", Toast.LENGTH_SHORT).show();

                    }else {
                        if (TextUtils.isEmpty(username)){
                            Toast.makeText(CreateGroup.this, "Enter User Name", Toast.LENGTH_SHORT).show();
    ...
    private void createGroup() {
        ...
        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(username)){
            Toast.makeText(this, "Enter name & username", Toast.LENGTH_LONG).show();
            return;
        }
                    ...
                    reference.child(timeStamp).child("Participants").child(Objects.requireNonNull(mAuth.getUid()))
                            ...
                            .addOnSuccessListener(aVoid1 -> {
                                ...
                                new Handler().postDelayed(() -> onBackPressed(), 1000);
                                    ...
                                    Toast.makeText(CreateGroup.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show());
