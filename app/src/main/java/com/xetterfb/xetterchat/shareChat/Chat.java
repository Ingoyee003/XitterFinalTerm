package com.xetterfb.xetterchat.shareChat;
...
import com.xetterfb.xetterchat.adapter.AdapterChat;
import com.xetterfb.xetterchat.MainActivity;
import com.xetterfb.xetterchat.model.ModelChat;
import com.xetterfb.xetterchat.model.ModelUser;
import com.xetterfb.xetterchat.R;
import com.xetterfb.xetterchat.SharedPref;
import com.xetterfb.xetterchat.notifications.Data;
import com.xetterfb.xetterchat.notifications.Sender;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds: snapshot.getChildren()){
                            if (ds.exists()){
                                Toast.makeText(Chat.this, "You're blocked by this user", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == PERMISSION_CODE) {
            if (grantResults.length > 0 && grantResults[0] ==
                ...
                Toast.makeText(Chat.this, "Storage permission Allowed", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(Chat.this, "Storage permission is Required", Toast.LENGTH_LONG).show();
            }
        }
    }
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, new Response.Listener<JSONObject>() {
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "AIzaSyCJMCOtXPhDTc033cUTXmLSkser3NFYDnY");
                                return headers;
                            }
                        };
